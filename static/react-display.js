	...
	render () {
		...
		return (
			React.createElement('div',{className: this.props.className},
					React.createElement('p', {}, "wrwerwer"),
					React.createElement('h2', {}, "WEWESDASD")
			)
  ...
  render() {
    if(this.state.logInInfo === null)
    {
      ...
      { className: 'formContainer'}, // properties
    	...
    	return(
    		React.createElement(Counter,{className:'main-body', count: this.count})
    	);
    }
  }  
};
